        ...
        expect(subject['AS-PDOXUPLINKS'])
          .to eq({:ipv4 =>
                    {"AS1221" => ["203.92.26.0/24", "203.31.4.0/24", "203.31.5.0/24", "122.200.24.0/23",
                                  "103.241.196.0/22", "103.129.227.0/24", "203.25.245.0/24", "202.36.14.0/24",
                                  "202.87.4.0/22", "203.57.38.0/24", "202.87.4.0/23", "202.87.4.0/24", "202.87.5.0/24",
                                  "103.78.241.0/24"],
                     "AS2764" => ["103.62.28.0/23", "203.24.208.0/24", "147.76.53.0/24", "147.76.241.0/24",
                                  "147.76.52.0/24", "147.76.28.0/24"],
                     "AS4565" => [],
                     "AS5650" => [],
