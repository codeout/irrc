      ...
      it 'returns the same result as Whois database' do
        expect(subject['AS-PDOXUPLINKS'])
          .to eq({:ipv4=>
                  ...
                  :ipv6=>
                    {"AS703"=>[],
                     "AS1221"=>["2001:8000::/20", "2401:a480::/48"],
                     "AS2764"=>[],
                     "AS7474"=>["2405:9000::/32"],
                     "AS7657"=>[],
                     "AS4565"=>[],
          ...
          .to eq(
                {:ipv4=>
                   {"AS16086"=>
                    ...
                    "AS49422"=>[],
                    "AS6793"=>[],
                    "AS8236"=>["193.105.76.0/24"],
                    "AS29282"=>
                      ["158.90.128.0/17", "217.69.48.0/20", "77.95.144.0/21", "77.95.144.0/22"],
                    "AS48156"=>
                      ["158.127.0.0/16",
                       "158.127.128.0/18",
                       "158.127.16.0/20",
                    ...
                    "AS41747"=>["194.0.80.0/22", "194.0.80.0/22"],
                    ...
                    "AS49282"=>["164.215.32.0/21", "185.18.76.0/22", "95.175.96.0/19"],
                    "AS198243"=>[],
                    ...
                    "AS16273"=>
                      ["193.110.108.0/23",
                       ...
                       "46.228.140.0/23",
                       "46.228.143.0/24"],
                    "AS201057"=>["185.162.156.0/22", "185.87.108.0/22", "85.194.204.0/22"],
                    "AS201056"=>
                      ["46.228.128.0/24",
                       "46.228.129.0/24",
                       "46.228.134.0/23",
                    ...
                    "AS39242"=>["109.70.160.0/21", "81.19.112.0/20"],
                    "AS198936"=>
                      ["185.159.238.0/23",
                       "91.105.248.0/21",
                       "91.105.248.0/24",
                    ...
                    "AS47536"=>
                      ["130.185.153.0/24",
                       ...
                       "5.157.6.0/24"],
                    "AS61133"=>[],
                    "AS58065"=>["5.157.12.0/24", "91.108.182.0/24"],
                    "AS206804"=>
                      ["141.98.212.0/24",
                       "141.98.214.0/24",
                       "141.98.215.0/24",
                    ...
                    "AS201422"=>
                      ["185.75.128.0/22",
                       ...
                       "185.75.129.0/24",
                       "185.75.130.0/24"],
                    "AS59397"=>["185.75.130.0/24", "185.75.131.0/24"],
                    "AS57692"=>
                      ["194.146.111.0/24",
                       "91.232.154.0/24",
                       "91.232.155.0/24",
                       "91.232.156.0/24"],
                    "AS199231"=>["185.4.228.0/22", "213.135.92.0/24"],
                    "AS50503"=>["109.204.128.0/17", "185.128.16.0/22"],
                    "AS35382"=>["5.23.56.0/21", "83.143.216.0/21"],
                    "AS199486"=>["31.47.64.0/21"],
                 ...
                 :ipv6=>
                   {"AS16086"=>
                    ...
                    "AS8145"=>["2a09:84c0:400::/40", "2a09:84c0::/32", "2a09:84c0::/39"],
                    "AS209633"=>[],
                    "AS15786"=>[],
                    "AS207390"=>["2a07:7840::/29"],
                    "AS49282"=>[],
                    "AS198243"=>["2a03:e580::/29"],
                    ...
                    "AS39242"=>["2a02:ef0::/32"],
                    "AS198936"=>["2a01:7bc0::/32", "2a01:7bc0::/32"],
                    ...
                    "AS202053"=>
                      ["2a03:3b00:1::/48",
                       ...
                       "2a09:51c0::/29"],
                    "AS25697"=>[],
                    "AS39324"=>["2a02:1370::/32", "2a0a:48c0::/32"],
                    "AS46805"=>[],
                    "AS47536"=>[],
                    "AS61133"=>[],
                    "AS58065"=>[],
                    ...
                    "AS201422"=>
                      ["2a03:4d20:1000::/36",
                       ...
                       "2a03:4d26::/32",
                       "2a03:4d27::/32"],
                    "AS59397"=>["2a03:4d22::/32", "2a03:4d25::/32"],
